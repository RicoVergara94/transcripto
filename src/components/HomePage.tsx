        ...
        <Box sx={{ width: "100%", overflowX: "hidden" }}>
          ...
          >
            ...
            >
              ...
              annotate sales transcripts. With the ability to add, edit, and
              delete comments, and attach relevant files, you can enhance the
              detail and context of your feedback. Our advanced summarization
              feature uses state-of-the-art language models to generate concise
              overviews of transcripts and comments, helping you quickly grasp
              key insights and make data-driven decisions. This solution
              directly supports Rilla's mission to provide actionable,
              data-driven feedback, improving sales coaching and strategic
              decision-making.
            </Typography>
          ...
          <Box sx={{ width: "100%", textAlign: "center", padding: "20px" }}>
            ...
            >
              ...
              Our team members, Oscar, Ayman, Shashank, and Rohit, bring
              together expertise in both backend and frontend development to
